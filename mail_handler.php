...
$message['message']=nl2br($message['message']); // Convert newline characters to line break html tag

$mail = new PHPMailer;
$mail->SMTPDebug = 0;           // Enable verbose debug output. Change to 0 to disable debugging output. For testing 3
...
$mail->addReplyTo($message['email'], $message['name']);                          // Add a reply-to address ex) $_POST['email']
